...
public class Game extends JFrame {
	...
	private class KeyboardController implements KeyListener {
		...
		public void keyPressed(KeyEvent e) {
			Pacman p1 = gameBoard.getPacman1();
			
			switch (e.getKeyCode()) {
			case KeyEvent.VK_LEFT: // Left
				p1.setDirection('L'); break;
			case KeyEvent.VK_UP: // Up
				p1.setDirection('U'); break;
			case KeyEvent.VK_RIGHT: // Right
				p1.setDirection('R'); break;
			case KeyEvent.VK_DOWN: // Down
				p1.setDirection('D'); break;
			case KeyEvent.VK_SPACE: // Space
				p1.setDirection('S'); break;
			}
			
			Pacman p2 = gameBoard.getPacman2();
			
			switch (e.getKeyCode()) {
			case KeyEvent.VK_A: // Left
				p2.setDirection('L'); break;
			case KeyEvent.VK_W: // Up
				p2.setDirection('U'); break;
			case KeyEvent.VK_D: // Right
				p2.setDirection('R'); break;
			case KeyEvent.VK_S: // Down
				p2.setDirection('D'); break;
			case KeyEvent.VK_SPACE: // Space
				p2.setDirection('S'); break;
			}
		}
