...
public class TrackerMonster2 extends TrackerMonster {

	public TrackerMonster2(Board b) {
		super(b);
	}
	
	public TrackerMonster2(Board b, int x, int y) {
		super(b, x, y);
	}
	...
	public void makeMove() {
		...
		int horiz_distance = Math.abs(getX() - board.getPacman2().getX());
		int vert_distance  = Math.abs(getY() - board.getPacman2().getY());
	...
	protected char getVerticalDirectionToPacman() {
		Pacman pacman = board.getPacman2();
